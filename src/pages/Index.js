                        ...
                        <div className="col-lg-8">
                            <div className="row gx-5 row-cols-1 row-cols-md-2">
                                <div className="col mb-5 h-100">
                                    ...
                                    <p className="mb-0">Paragraph of text beneath the heading to explain the heading. Here is
                    ...
                    <div className="row gx-5 justify-content-center">
                        <div className="col-lg-10 col-xl-7">
                            <div className="text-center">
                                <div className="fs-4 mb-4 fst-italic">"Working with Start Bootstrap templates has saved me tons
                        ...
                        <div className="col-lg-4 mb-5">
                            <div className="card h-100 shadow border-0">
                                ...
                                <div className="card-body p-4">
                                    ...
                                    <p className="card-text mb-0">Some quick example text to build on the card title and make up
                        ...
                        <div className="col-lg-4 mb-5">
                            <div className="card h-100 shadow border-0">
                                ...
                                <div className="card-body p-4">
                                    <div className="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                    <a className="text-decoration-none link-dark stretched-link" href="#!">
                                        <h5 className="card-title mb-3">The last blog post title is a little bit longer than the
                                            others</h5>
                                    </a>
                                    <p className="card-text mb-0">Some more quick example text to build on the card title and
                    ...
                    <aside className="bg-primary bg-gradient rounded-3 p-4 p-sm-5 mt-5">
                        <div className="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
                            ...
                            <div className="ms-xl-4">
                                ...
                                <div className="small text-white-50">We care about privacy, and will never share your data.
                                </div>
                            </div>
                        </div>
                    </aside>
